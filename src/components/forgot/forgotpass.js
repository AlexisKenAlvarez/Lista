...
const Forgot = () => {
  ...
  const forgotContent = (
    ...
    <div className='relative mt-10'>
      ...
      <input type="button" name="button" value="Confirm" className="font-space cursor-pointer mt-6 w-full h-11 bg-gray-50/50 text-purple uppercase font-bold hover:bg-gray-100 transition-all ease-in-out md:text-md" onClick={handleForgot}></input>
        ...
        <section className='w-100 h-screen bg-gradient bg-cover'>
            ...
            <div className='h-[60%] w-100 flex justify-center items-center'>
              <div className='h-auto w-100'>
                <img src="https://unix-shop.s3.ap-southeast-1.amazonaws.com/lista/listalogo-2.webp" alt="Logo" className="w-70 mx-auto mt-6 md:w-56"></img>
